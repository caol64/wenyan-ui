...
<svg width={w} height={w} viewBox="-8 -8 54 54" fill="rgba(0,0,0,0.65)" xmlns="http://www.w3.org/2000/svg">
    <g>
        <g>
            <path
                fill="#07C060"
